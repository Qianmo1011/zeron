...
pub fn blurb(harness: HarnessId) -> &'static str {
    match harness {
        ...
        HarnessId::QoderCn => "Qoder CN's coding agent, driven through Qoder CLI CN's ACP server.",
        HarnessId::Codebuddy => "Tencent's CodeBuddy Code agent, driven through its ACP server.",
